function generateNavbar() {
  ...
  const isInBooksFolder = window.location.pathname.includes("/Books/");
    ...
    html = `
      <div class="side_Nav">
        ...
        <ul class="NavLink">
            ...
            <li><i class="fa-solid fa-book" style="color: #fff3db;"></i><a href="${prefix}viewBorrowed.html">Borrowd books</a></li>
